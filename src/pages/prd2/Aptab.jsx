      ...
      <TabsContainer>
        ...
        <span className="heading">
          ...
          <div className="description">
            ...
            <Card1/>
          <span className="heading">
            <div className="heading1">GATE - Subject Wise Preparation Packages</div>
            <div className="description" style={{width:"70%", marginBottom:"2%"}}>WLorem ipsum dolor sit amet, consectetur ad ipiscing elit. Integer nec odio. Praesent libero Sed cursus ante dapibus diam. Sed nisi</div>
          </span>
          <Aplp style={{width:"70%",marginBottom:"2%"}}/>
        </TabPanel>
